...
namespace PopularStringAlgorithms
{
    ...
    public class Anagram
    {
        ...
        /// Этот алгоритм работает за время O(n + k), где n - длина строк, а k - размер алфавита, 
        /// и использует дополнительное пространство O(k) для хранения массива count.Этот алгоритм может быть быстрее,
        /// , если k много меньше, чем n. Однако, он может быть неэффективным, 
        /// если k очень большой, например, если строки содержат символы из разных систем письма.
